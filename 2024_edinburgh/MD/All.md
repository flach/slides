...
- 2024 - AI claims both Physics and Chemistry Nobel prizes <!-- .element: class="fragment" -->
...
- $P(Y|X)-P(Y)$ <!-- .element: class="fragment" -->
- $P(Y|X)-P(X)$ <!-- .element: class="fragment" -->
- $(TPR+TNR)/2$ <!-- .element: class="fragment" -->
- $(TPR+Precision)/2$ <!-- .element: class="fragment" -->

What is the scale of the following ratios? 
- $P(AB)/P(A)$ <!-- .element: class="fragment" -->
- $P(A|B)/P(A)$ <!-- .element: class="fragment" -->
